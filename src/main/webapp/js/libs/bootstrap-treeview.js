...
;(function ($, window, document, undefined) {
	...
	var Tree = function (element, options) {
		...
		return {
			...
			//删除节点
			deleteChildNodes: $.proxy(this.deleteChildNodes, this),
			setDeleteChildNodes: $.proxy(this.setDeleteChildNodes, this),
			//删除节点
...
@param {optional Object} options.node;
	...
	Tree.prototype.deleteChildNodes = function (identifiers, options) {
		this.forEachIdentifier(identifiers, options, $.proxy(function (node, options) {
			this.setDeleteChildNodes(node, options);
		}, this));
	};

	Tree.prototype.setDeleteChildNodes = function (node,options) {
		if (node.nodes != null) {
			for (var i = node.nodes.length - 1; i >= 0; i--) {
				node.nodes.splice(i, 1);
			}
